    ...
    <div className="bg-slate-50 font-sans text-gray-900 min-h-screen overflow-hidden">
      ...
      <header className="flex items-center justify-between px-4 py-3 bg-white border-b border-gray-200">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-sm font-bold">Keypoint Detection Tool</h1>
            <div className="text-xs text-gray-500">Keypoint Detection & Drawing</div>
          </div>
        </div>
      ...
      <main className="grid grid-cols-1 xl:grid-cols-4 gap-4 p-4 h-screen">
        ...
        <aside className="bg-white border border-gray-200 rounded-xl p-4 overflow-y-auto">
          ...
          <div className="mb-1">
            ...
            <div className="space-y-3">
              ...
              <div className="border border-gray-200 rounded-lg bg-white p-3 shadow-sm">
                <div className="mb-2">
                  <span className="text-sm font-medium text-gray-700">Brush Size: <span>3</span>px</span>
                </div>
                <input type="range" min="1" max="20" defaultValue="3" className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer" />
          ...
          {/* Keypoint Types */}
          <div className="mb-6">
            <h3 className="text-lg font-bold mb-3">Keypoint Types</h3>
            <div className="space-y-2">
              <div className="flex items-center justify-between border border-gray-200 rounded-lg bg-white p-2 shadow-sm hover:shadow-md transition-shadow">
                <span className="font-bold text-sm text-red-500">Head</span>
                <button className="border border-gray-300 rounded-md px-2 py-1 bg-white text-xs font-semibold">Select</button>
              </div>
              <div className="flex items-center justify-between border border-gray-200 rounded-lg bg-white p-2 shadow-sm hover:shadow-md transition-shadow">
                <span className="font-bold text-sm text-blue-600">Shoulder</span>
                <button className="border border-gray-300 rounded-md px-2 py-1 bg-white text-xs font-semibold">Select</button>
              </div>
              <div className="flex items-center justify-between border border-gray-200 rounded-lg bg-white p-2 shadow-sm hover:shadow-md transition-shadow">
                <span className="font-bold text-sm text-green-600">Elbow</span>
                <button className="border border-gray-300 rounded-md px-2 py-1 bg-white text-xs font-semibold">Select</button>
              </div>
              <div className="flex items-center justify-between border border-gray-200 rounded-lg bg-white p-2 shadow-sm hover:shadow-md transition-shadow">
                <span className="font-bold text-sm text-amber-500">Wrist</span>
                <button className="border border-gray-300 rounded-md px-2 py-1 bg-white text-xs font-semibold">Select</button>
              </div>
              <div className="flex items-center justify-between border border-gray-200 rounded-lg bg-white p-2 shadow-sm hover:shadow-md transition-shadow">
                <span className="font-bold text-sm text-violet-600">Hip</span>
                <button className="border border-gray-300 rounded-md px-2 py-1 bg-white text-xs font-semibold">Select</button>
              </div>
              <div className="flex items-center justify-between border border-gray-200 rounded-lg bg-white p-2 shadow-sm hover:shadow-md transition-shadow">
                <span className="font-bold text-sm text-purple-500">Knee</span>
                <button className="border border-gray-300 rounded-md px-2 py-1 bg-white text-xs font-semibold">Select</button>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between border border-gray-200 rounded-lg bg-white p-2 shadow-sm hover:shadow-md transition-shadow">
                <span className="font-bold text-sm text-green-600">Add Keypoint</span>
                <button className="border border-gray-300 rounded-md px-2 py-1 bg-white text-xs font-semibold">Enable</button>
              </div>
              <div className="flex items-center justify-between border border-gray-200 rounded-lg bg-white p-2 shadow-sm hover:shadow-md transition-shadow">
                <span className="font-bold text-sm text-blue-600">Connect Points</span>
                <button className="border border-gray-300 rounded-md px-2 py-1 bg-white text-xs font-semibold">Enable</button>
              </div>
              <div className="flex items-center justify-between border border-gray-200 rounded-lg bg-white p-2 shadow-sm hover:shadow-md transition-shadow">
...
export default KeypointDetection;
