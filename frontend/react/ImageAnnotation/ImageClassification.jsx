      ...
      <header className="flex items-center justify-between px-4 py-3 bg-white border-b border-gray-200">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-xs text-gray-500">Image Classification</div>
          </div>
        </div>
        ...
        <aside className="bg-white border border-gray-200 rounded-xl p-4 overflow-y-auto">
          ...
          <div className="mb-1">
            ...
            <div className="space-y-3">
              ...
              {/* Color Palette */}
              <div className="border border-gray-200 rounded-lg bg-white p-3 shadow-sm">
                <label className="block text-sm font-semibold mb-2">Drawing Colors</label>
          ...
          <div className="mb-6">
            <h3 className="text-lg font-bold mb-3">Detection Categories</h3>
          ...
          {/* Confidence Level */}
          <div className="mb-6">
            <h3 className="text-lg font-bold mb-3">Confidence Level</h3>
            <div className="px-2">
              <div className="mb-3">
                <span className="text-sm font-medium text-gray-700">Confidence: <span>50</span>%</span>
              </div>
